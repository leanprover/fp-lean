...
```
{{#command {feline/2} {feline/2} {cat test3.txt | ./build/bin/feline test1.txt - test2.txt} }}
```
should yield
```
{{#command_out {feline/2} {cat test3.txt | ./build/bin/feline test1.txt - test2.txt} {feline/2/expected/test1purr2.txt}}}
```
